...
const reject = (construct, position, message, hint) => ({ ok: false, rejection: { code: 'validation-error', construct, position: position == null ? 0 : position, message: message || `${construct} is not supported`, hint: hint || 'Simplify the SQL or use queries.excel_power_query for raw M.' } });
